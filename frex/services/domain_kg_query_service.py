...
class DomainKgQueryService(_GraphQueryService):
    ...
    def get_all_objects_by_class(self, *, target_class_uri: URIRef, object_type: Type[T]) -> Generator[T, None, None]:
        """
    ...
    def _get_object_by_uri(self, *, target_uri: URIRef, object_type: Type[T]) -> T:
        ...
        if not hasattr(object_type, "prop_to_uri"):
            raise MalformedContentException(uri=target_uri, message="The object type you've specified does not "
        ...
        try:
            ...
            raise MalformedContentException(uri=target_uri, message="A value error occurred when trying to produce "
