...
from frex.models import Explanation, DomainObject, AutoGeneratedClass
...
class DomainKgQueryService(_GraphQueryService):
    ...
    def get_all_objects_by_class(self, *, target_class_uri: URIRef, object_type: Type) -> Generator[DomainObject, None, None]:
        """
    ...
    def get_object_by_uri(self, *, target_uri: URIRef, object_type: Type) -> DomainObject:
        """
    ...
    def _get_object_by_uri(self, *, target_uri: URIRef, object_type: Type) -> DomainObject:
        """
